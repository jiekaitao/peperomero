<?php
	...
	$header_style = onepagepro_get_option('general', 'header-plain-style', 'menu-right');
	...
	$header_wrap_class .= ' onepagepro-sticky-navigation';
	if( $header_style == 'center-logo' || $body_layout == 'boxed' || 
		$body_margin != '0px' || $header_background_style == 'transparent' ){
		
		$header_wrap_class .= ' onepagepro-style-slide';
	}else{
		$header_wrap_class .= ' onepagepro-style-fixed';
	}
?>	
<header class="onepagepro-header-wrap onepagepro-header-style-plain <?php echo esc_attr($header_wrap_class); ?>" <?php
		if( !empty($navigation_offset) ){
			echo 'data-navigation-offset="' . esc_attr($navigation_offset) . '" ';
		}
	?> >
	<div class="onepagepro-header-background" ></div>
	<div class="onepagepro-header-container <?php echo esc_attr($header_container_class); ?>">
		...
		<div class="onepagepro-header-container-inner clearfix">
			...
			<?php
				...
				if( has_nav_menu('right_menu') || $enable_search || $enable_cart || $enable_right_button ){
					...
					// cart icon
					if( $enable_cart ){
						echo '<div class="onepagepro-main-menu-cart" id="onepagepro-menu-cart" >';
					...
					if( has_nav_menu('right_menu') && $header_style == 'splitted-menu'  ){
						echo '<div class="onepagepro-main-menu-left-wrap clearfix onepagepro-item-pdlr onepagepro-navigation-top" >';
						onepagepro_get_custom_menu(array(
							'container-class' => 'onepagepro-main-menu-right',
							'button-class' => 'onepagepro-right-menu-button onepagepro-top-menu-button',
							'icon-class' => 'fa fa-bars',
