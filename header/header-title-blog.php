<?php
	...
	if( $title_style != 'none' && $title_style != 'inside-content' ){	
		...
		if( $feature_image_pos == 'title-background' ){
			...
			$extra_class .= ' onepagepro-feature-image';
		...
		echo '<div class="onepagepro-blog-title-wrap ' . esc_attr($extra_class) . '" ' . gdlr_core_esc_style(array(
			'background-image' => empty($title_background)? '': $title_background
		)) . '>';
		echo '<div class="onepagepro-header-transparent-substitute" ></div>';
		if( empty($title_overlay_opacity) && empty($background_overlay_color) ){
			echo '<div class="onepagepro-blog-title-top-overlay" ></div>';
		}
		echo '<div class="onepagepro-blog-title-overlay" ' . gdlr_core_esc_style(array(
		...
		echo '<div class="onepagepro-blog-title-container onepagepro-container" >';
		echo '<div class="onepagepro-blog-title-content onepagepro-item-pdlr" ' . gdlr_core_esc_style(array(
		...
		if( function_exists('bcn_display') ){
			echo '<div class="onepagepro-breadcrumbs" >';
			echo '<div class="onepagepro-breadcrumbs-container onepagepro-container" >';
			echo '<div class="onepagepro-breadcrumbs-item onepagepro-item-pdlr" >';
       		bcn_display();
       		echo '</div>';
       		echo '</div>';
       		echo '</div>';
