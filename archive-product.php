 ...
 */
	...
	$sidebar_type = onepagepro_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = onepagepro_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = onepagepro_get_option('general', 'woocommerce-archive-sidebar-right');		
