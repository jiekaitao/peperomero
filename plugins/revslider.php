<?php
	...
	add_filter('revslider_getUsedFonts', 'onepagepro_revslider_getUsedFonts');
	if( !function_exists('onepagepro_revslider_getUsedFonts') ){
		function onepagepro_revslider_getUsedFonts( $used_font ){
